...
public import c.zmq.czmq_library : zhash_t, zframe_t, zlist_t;
...
alias zhash_free_fn = void function (void* data);
...
void* zhash_freefn (zhash_t* self, const(char)* key, void function () free_fn);
...
void zhash_comment (zhash_t* self, const(char)* format, ...);
...
//  strings.                                                             
//  Caller owns return value and must destroy it when done.
zframe_t* zhash_pack (zhash_t* self);
...
int zhash_load (zhash_t* self, const(char)* filename);

//  When a hash table was loaded from a file by zhash_load, this method will
//  reload the file if it has been modified since, and is "stable", i.e. not
//  still changing. Returns 0 if OK, -1 if there was an error reloading the 
//  file.                                                                   
int zhash_refresh (zhash_t* self);

//  Set hash for automatic value destruction
void zhash_autofree (zhash_t* self);

//  Self test of this class.
void zhash_test (bool verbose);
