...
zmsg_t* zmsg_new_signal (ubyte status);
...
//  Returns 0 on success, -1 on error.                     
int zmsg_pushstrf (zmsg_t* self, const(char)* format, ...);

//  Push formatted string as new frame to end of message.
//  Returns 0 on success, -1 on error.                   
int zmsg_addstrf (zmsg_t* self, const(char)* format, ...);
...
alias zmsg_dump = zmsg_print;
alias zmsg_dump_to_stream = zmsg_fprint;
