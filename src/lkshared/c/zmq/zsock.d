...
//  isn't supported.                                               
int zsock_unbind (zsock_t* self, const(char)* format, ...);
...
//  Returns 0 if OK, -1 if the endpoint was invalid or the function
//  isn't supported.                                               
int zsock_disconnect (zsock_t* self, const(char)* format, ...);
...
//  details.                                                             
int zsock_vsend (void* self, const(char)* picture, va_list argptr);
...
int zsock_recv (void* self, const(char)* picture, ...);

//  Receive a 'picture' message from the socket (or actor). This is a    
//  va_list version of zsock_recv (), so please consult its documentation
//  for the details.                                                     
int zsock_vrecv (void* self, const(char)* picture, va_list argptr);
...
int zsock_bsend (void* self, const(char)* picture, ...);
...
//  a message.                                                              
int zsock_brecv (void* self, const(char)* picture, ...);
...
int zsock_signal (void* self, ubyte status);
...
//  Available from libzmq 4.1.0.                        
void zsock_set_connect_rid_bin (void* self, const(ubyte)* connect_rid);
...
//  Available from libzmq 4.0.0.                            
void zsock_set_curve_publickey_bin (void* self, const(ubyte)* curve_publickey);
...
//  Available from libzmq 4.0.0.                            
void zsock_set_curve_secretkey_bin (void* self, const(ubyte)* curve_secretkey);
...
//  Available from libzmq 4.0.0.                            
void zsock_set_curve_serverkey_bin (void* self, const(ubyte)* curve_serverkey);
...
//  Available from libzmq 4.0.0.                 
void zsock_set_gssapi_service_principal (
    void* self,
    const(char)* gssapi_service_principal);
...
//  Available from libzmq 3.0.0.                
void zsock_set_delay_attach_on_connect (
    void* self,
...
extern (D) auto zsock_new(T)(auto ref T t)
{
    return zsock_new_checked(t, __FILE__, __LINE__);
}

extern (D) auto zsock_new_pub(T)(auto ref T e)
{
    return zsock_new_pub_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_sub(T0, T1)(auto ref T0 e, auto ref T1 s)
{
    return zsock_new_sub_checked(e, s, __FILE__, __LINE__);
}

extern (D) auto zsock_new_req(T)(auto ref T e)
{
    return zsock_new_req_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_rep(T)(auto ref T e)
{
    return zsock_new_rep_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_dealer(T)(auto ref T e)
{
    return zsock_new_dealer_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_router(T)(auto ref T e)
{
    return zsock_new_router_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_pull(T)(auto ref T e)
{
    return zsock_new_pull_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_push(T)(auto ref T e)
{
    return zsock_new_push_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_xpub(T)(auto ref T e)
{
    return zsock_new_xpub_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_xsub(T)(auto ref T e)
{
    return zsock_new_xsub_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_pair(T)(auto ref T e)
{
    return zsock_new_pair_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_new_stream(T)(auto ref T e)
{
    return zsock_new_stream_checked(e, __FILE__, __LINE__);
}

extern (D) auto zsock_destroy(T)(auto ref T t)
{
    return zsock_destroy_checked(t, __FILE__, __LINE__);
}

zsock_t* zsock_new_checked (int type, const(char)* filename, size_t line_nbr);

void zsock_destroy_checked (
    zsock_t** self_p,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_pub_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_sub_checked (
    const(char)* endpoint,
    const(char)* subscribe,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_req_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_rep_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_dealer_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_router_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_push_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_pull_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_xpub_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_xsub_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_pair_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);

zsock_t* zsock_new_stream_checked (
    const(char)* endpoint,
    const(char)* filename,
    size_t line_nbr);
