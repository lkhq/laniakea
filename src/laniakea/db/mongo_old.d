 ...
 * but not threads.
 */
final class MongoLegacyDatabase
{
    // Thread local
    private static MongoLegacyDatabase instance_ = null;

    @trusted
    static MongoLegacyDatabase get ()
    {
        if (instance_ is null)
            instance_ = new MongoLegacyDatabase ();
        return instance_;
    }
