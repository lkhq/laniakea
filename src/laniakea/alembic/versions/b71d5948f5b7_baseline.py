...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            'status', sa.Enum('UNKNOWN', 'ACTIVE', 'IDLE', 'MISSING', 'DEAD', name='workerstatus'), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'priority',
            sa.Enum('UNKNOWN', 'REQUIRED', 'IMPORTANT', 'STANDARD', 'OPTIONAL', 'EXTRA', name='packagepriority'),
            nullable=True,
        ),
